...
class CompetenceBaseType(BaseModel):
    """
    CompetenceBaseType
    """
    ...
    __properties = ["id", "abbreviation", "title", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompetenceBaseType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompetenceBaseType:
        """Create an instance of CompetenceBaseType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompetenceBaseType.parse_obj(obj)

        _obj = CompetenceBaseType.parse_obj({
            "id": obj.get("id"),
