...
class EdgeType(BaseModel):
    ...
    __properties = ["id", "title", "abbreviation", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EdgeType:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EdgeType:
        """Create an instance of EdgeType from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EdgeType.parse_obj(obj)

        _obj = EdgeType.parse_obj({
            "id": obj.get("id"),
            "title": obj.get("title"),
